...
internal static class GameManagerPatches
{
    ...
    {
        private static void Postfix(GameManager __instance) => _ = __instance.m_ConditionSystems.GetComponent<Heating>() ?? __instance.m_ConditionSystems.AddComponent<Heating>();
    }
}